...
export function updateLifecycle(stage) {
...
function createCustomElement() {
  ...
  template.innerHTML = `
    <player-card>
      <player-img src="resources/cristiano-ronaldo.jpeg"></player-img>
...
function addElementToPage(customElement) {
  document.querySelector('#elementWrapper').insertAdjacentElement('afterbegin', customElement);
}
...
function bindEvents() {
  ...
  btnModify.addEventListener('click', () => {
    if (!isModified && isAdded) {
      newCustomElement.editPic('resources/lionel-messi.jpeg');
