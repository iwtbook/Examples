...
_makeRequest : function (request) {		
									...
									if (!request.oneway && request.async)
									{
										...
										if (request.timeout && request.timeoutTimerID == null)
...
_handleCallbacks : function(response) {
										...
										if (status == 200)
										{
										    ...
										    if (response.responseContentType)
										    {
										 	...
										 	AjaxTCR.comm._handleFail(response, status + " " + response.xhr.statusText);
