  ...
  #stylesAndMarkup = closedOrOpen => {
    return `
      <style>
        ...
        #light-dom {
          background-color: var(--bg-light-dom, ${constants['--bg-light-dom']});
        }

        #light-dom-unedited {
          background-color: var(--bg-light-dom-unedited, ${constants['--bg-light-dom-unedited']});
        }

        #shadow-dom {
          background-color: var(--bg-shadow-dom, ${constants['--bg-shadow-dom']});
        }

        #wrapper {
          align-items: center;
          background-color: ${constants[`--bg-${closedOrOpen}`]};
          display: grid;
          height: 100%;
